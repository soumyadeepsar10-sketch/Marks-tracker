...
import { Hash, Percent, Maximize2 } from "lucide-react";
            ...
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                <button 
                  ...
                  className="p-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-white transition-all transform hover:scale-110"
                  id="expand-analytics-btn"
                >
